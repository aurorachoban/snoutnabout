...
import { PawPrint, Heart } from "@/components/Icons";
          ...
          <CartProvider>
            ...
            <footer className="border-t border-gray-100 bg-white py-8">
              <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-sm text-gray-400">
                ...
                <p className="flex items-center gap-1">&copy; {new Date().getFullYear()} Snout &amp; About. Made with <Heart className="w-4 h-4 text-pink-400 inline" /> for pets.</p>
              </div>
            </footer>
          </CartProvider>
        </AuthProvider>
